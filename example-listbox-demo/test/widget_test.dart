...
void main() {
  testWidgets('FxListBox Demo app navigation smoke test', (
    ...
    // Verify app title and start on Page 1 / 11
    expect(find.text('FxListBox Interactive Spec Gallery'), findsOneWidget);
    expect(find.text('Page 1 / 11'), findsOneWidget);
    ...
    // Verify we navigated to Page 2 / 11
    expect(find.text('Page 2 / 11'), findsOneWidget);
    ...
    // Verify we are back on Page 1 / 11
    expect(find.text('Page 1 / 11'), findsOneWidget);
  });
}
